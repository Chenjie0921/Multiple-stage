...
class Compose(object):
    ...
    def __call__(self, frame_indices):
        for i, t in enumerate(self.transforms):
            ...
            #         else:
            #             start_frame = random.randint(frame_indices[0],frame_indices[0]+start_range-1)
            #         # frame_indices_tmp.append([start_frame+x*interval for x in range(16)])
...
class SlidingWindow(object):
    ...
    def __call__(self, frame_indices):
        ...
        #     # if len(frame_indices) < self.size:
        #     #     out.append(self.loop(frame_indices))
        #     #     break
        #     # else:
        #     out.append(sample)
        # else:
